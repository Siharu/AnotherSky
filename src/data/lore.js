...
export const LORE = [
  ...
  { id:13, title:"Relay Seven", text:"There were eight relays before this one. You can still find the masts if you walk far enough - dead lattice standing over the streets like nobody told it to stop. Nobody who staffed any of them is on record as having left. WNCORE's own logs call that turnover. Turnover implies somewhere to turn over to." },
